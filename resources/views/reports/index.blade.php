...
@section('content')
	...
	<script src="/assets/js/facultyCalls.js" defer></script>
	<div class="container">
		<div class="card mb-3">
			<div class="card-body">
					...
					<div class="col">
						<div class="card h-100">
							<div class="card-body">
								...
								<p class="card-text">List of Students that are owing any fee(grouped by their classes)
								</p>
							</div>
					...
					<div class="col">
						<div class="card h-100">
							<form action="/reports/receiptsByDateRange" method="GET">
								<div class="card-body">
									<h5 class="card-title">All Receipts Issued Between Date Range</h5>
									<p class="card-text"> All Receipts Between Start Date and End Date</p>
									<div class="row">
										<div class="form-group"><label for="">Start Date</label><input type="date" name="startDate" id=""
												class="form-control"></div>
										<div class="form-group"><label for="">End Date</label><input type="date" name="endDate" id=""
												class="form-control"></div>
									</div>
								</div>
								<div class="card-footer">
					...
					<div class="col">
						<div class="card h-100">
							<form action="/reports/receiptsByName" method="GET">
								...
								<div class="card-footer">
									<button type="submit" class="btn btn-info"> <i class="fa fa-search" aria-hidden="true">Searc h</i></button>
								</div>
							</form>
						</div>
					</div>
							...
							<form action="/reports/receiptsByClass" method="GET">
								<div class="card-body">
									...
									<div class="row">
										<div class="form-group">
											<label for="">Faculty</label>
											<select name="level" id="cboLevels" class="form-select">
