...
@section('content')
	<div class="container">
		...
		<div class="card-header card">
			<form action="/studentPayments" method="POST">
				...
				<div class="row">
					...
					<div class="form-group col-lg-2 col-md-4 col-sm-6 col-xs-12"><label for="">Registration
							Number</label><input type="text" id="regno" name="StudentNO" required class="form-control">
					</div>
					<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12"><label for="">Details</label><input type="text"
							name="details" id="details" class="form-control" disabled>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-3 form-group"><label for="">Session</label><select name="session" id="" class="form-select">
