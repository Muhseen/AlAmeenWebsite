<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
	...
	<div class="sidenav-header ">
		...
		<a class="navbar-brand m-0" href="#">
			...
			<span class="ms-1 font-weight-bold">ACHST <br />
			</span>
		</a>
	</div>
	...
	<div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link  " href="/applicantPayments">
					<div style="background-image: url('/assets/img/finances.png'); background-size:contain;"
						class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
					</div>
					<span class="nav-link-text ms-1">Make Applicant Payments
			...
			<li class="nav-item">
				<a class="nav-link  " href="/programmes">
					...
					<span class="nav-link-text ms-1">View Programmes

					</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link  " href="/programmes/create">
					<div style="background-image: url('/assets/img/finances.png'); background-size:contain;"
						class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
					</div>
					<span class="nav-link-text ms-1">Create Programme

					</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link  " href="/processPromotions">
					<div style="background-image: url('/assets/img/finances.png'); background-size:contain;"
						class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
					</div>
					<span class="nav-link-text ms-1">Process Promotions
