			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="parentoccupation" value="{{ $student->parentoccupation }}" class="form-control">
					</div>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
					<div class="form-group">
					...
					<div class="form-group">
						...
						<select name="faculty" id="" class="form-select">
							@foreach ($faculties as $faculty)
								<option value="{{ $faculty->faculty }}" {{ $student->faculty == $faculty->faculty ? 'selected' : '' }}>
